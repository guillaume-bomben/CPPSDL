...
Window::Window(){
    ...
    SDL_Window* window = SDL_CreateWindow("Ma Fenêtre SDL", SDL_WINDOWPOS_CENTERED,SDL_WINDOWPOS_CENTERED,800, 800,SDL_WINDOW_SHOWN);
    ...
    // Couleur initiale de fond (blanc)
